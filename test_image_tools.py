...
@patch('image_tools.cv2.imencode')
def test_convert_to_jpeg_raises_an_exception_if_the_conversion_fails(imencode_mock):
    # Given
    image_list, image_name_list = load_images('images')
    target_image = image_list[0]
...
@patch('builtins.open')
def test_save_binary_path_uses_open_builtin_to_save_images(open_builtin_mock):
    # Given
    image_list, image_name_list = load_images('images')
...
@patch('image_tools.convert_to_jpeg')
@patch('image_tools.save_binary_file')
def test_save_images_calls_save_binary_file_function(save_binary_file_mock, convert_to_jpeg_mock):
    # Given
    image_list, image_name_list = load_images('images')
